...
{
    public class GTSUser : EntityBase
    {   
        ...
        public GTSUser(Email email, string password)
        {
            Email = email;
            Password = password;

            new AddNotifications<GTSUser>(this)
        ...
        public GTSUser(Name name, Email email, string password)
        {
            Name = name;
            Email = email;
            Password = password;
